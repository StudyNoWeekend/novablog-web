  ...
  return (
    <>
      ...
      <aside
        role="group"
        aria-label="音乐播放器"
        className="fixed inset-x-0 bottom-0 z-50 border-t border-border bg-surface shadow-glow animate-[player-slide-up_0.3s_ease-out] motion-reduce:animate-none"
      >
        <div className="mx-auto flex h-24 w-full max-w-3xl flex-col justify-center gap-1 px-4">
          ...
          {player.urlError ? (
            <div className="flex h-5 items-center justify-center gap-2 text-xs text-text-muted">
              ...
              <button
                ...
                className={`flex cursor-pointer items-center gap-1 rounded-md border border-border px-2 py-0.5 text-xs text-text-secondary transition-colors duration-200 hover:border-accent hover:text-accent ${focusRing}`}
              >
          ...
          <div className="flex h-14 items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              aria-label="上一首"
              className={`flex h-10 w-10 shrink-0 cursor-pointer items-center justify-center rounded-full text-text-secondary transition-colors duration-200 hover:bg-surface-elevated hover:text-accent disabled:cursor-not-allowed disabled:opacity-50 ${focusRing}`}
            >
            ...
            <button
              ...
              className={`flex h-11 w-11 shrink-0 cursor-pointer items-center justify-center rounded-full bg-accent text-background shadow-glow transition-transform duration-200 hover:scale-105 ${focusRing}`}
            >
              {player.isPaused ? (
            ...
            <button
              ...
              onClick={player.stop}
              aria-label="关闭播放"
              className={`flex h-10 w-10 shrink-0 cursor-pointer items-center justify-center rounded-full text-text-muted transition-colors duration-200 hover:bg-surface-elevated hover:text-text-primary ${focusRing}`}
            >
