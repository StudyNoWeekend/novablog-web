    ...
    <>
      ...
      <section className="sticky top-20 z-30 border-b border-border bg-background/95 py-4 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl flex-col gap-3 px-4 sm:px-6 lg:px-8">
          <div className="no-scrollbar flex flex-wrap items-center justify-center gap-2">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-24 text-center">
              <Compass className="h-10 w-10 text-text-subtle" strokeWidth={1.2} />
              <p className="mt-4 font-hand text-3xl text-text-subtle">no plans yet…</p>
              <p className="mt-2 text-lg text-text-muted">旅行美食攻略还在路上，敬请期待</p>
            </div>
          )}
        </div>
      </section>
