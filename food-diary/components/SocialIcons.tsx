...
export function SocialIconLink({
  ...
  return (
    <a
      ...
      aria-label={platform}
      className={`flex ${dim} cursor-pointer items-center justify-center rounded-full text-text-muted transition-colors duration-200 hover:bg-accent hover:text-white`}
    >
