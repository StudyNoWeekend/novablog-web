...
import { Caveat, ZCOOL_KuaiLe } from "next/font/google";
import "./globals.css";
...
export default async function RootLayout({
  ...
  return (
    <html lang="zh-CN">
      <body
        className={`${caveat.variable} ${zcool.variable} min-h-screen bg-background font-body text-text-primary antialiased`}
      >
