...
import { ArticleCard, categoryBadgeStyle, formatCount } from "@/components/ArticleCard";
              ...
              <aside className="space-y-8 lg:sticky lg:top-36 lg:self-start">
                ...
                {hotArticles.length > 0 && (
                  <div className="rounded-radius-md border border-border bg-surface p-5 shadow-card">
                    <h2 className="mb-4 flex items-center gap-2 font-heading text-base text-text-primary">
                ...
                {tags.length > 0 && (
                  <div className="rounded-radius-md border border-border bg-surface p-5 shadow-card">
                    <h2 className="mb-4 font-heading text-base text-text-primary">
                      标签云
                    </h2>
                    <div className="flex flex-wrap gap-2">
                      {tags.map((tag) => (
                        <Link
                          ...
                          className={`min-h-8 cursor-pointer rounded-full border px-3 py-1 text-xs transition-all duration-200 hover:-translate-y-0.5 ${categoryBadgeStyle(tag.id)}`}
                        >
                          #{tag.name}
                        </Link>
                      ))}
