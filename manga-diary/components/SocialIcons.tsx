...
export function SocialIconLink({
  ...
  return (
    <a
      ...
      aria-label={platform}
      className={`flex ${dim} cursor-pointer items-center justify-center rounded-full border border-border bg-surface text-text-muted transition-colors duration-200 hover:border-accent hover:bg-accent hover:text-ink`}
    >
